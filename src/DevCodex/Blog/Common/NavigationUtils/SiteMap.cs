...
namespace DevCodex.Blog.Common.NavigationUtils
{
    public static class SiteMap
    {
        ...
        new("TDD in .NET: Anti-Patterns & When NOT to Use TDD",
            ...
            isPublished: true,
            isOlderThumbnailFormat: false),
        new("AWS Bedrock with .NET: Getting Started",
            "/blog/ai/bedrock",
            ...
            isPublished: true,
            isOlderThumbnailFormat: false),
        new("AWS Bedrock with .NET: Advanced Integration & Production Setup",
            "/blog/ai/bedrock/advanced",
            new DateTime(2026, 1, 10),
            "images/blog/ai/bedrock/banner.svg",
            ["AI", "AWS Bedrock", "API", ".NET", "C#", "Production", "IAM", "Security"],
            isPublished: true,
            isOlderThumbnailFormat: false),
        new("AWS Bedrock with .NET: Conversational AI Converse API",
            "/blog/ai/bedrock/converse",
